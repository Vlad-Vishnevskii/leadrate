...
/* harmony import */ var _modules_get_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/get-json */ "./js/modules/get-json.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_get_json__WEBPACK_IMPORTED_MODULE_4__["download"])();
  });
}); // ---------------------------------
...
var itemTemplate = document.querySelector('#item').content.querySelector('.todo__item');
var userQuantity = 0;
var randomDescription;
var percentageOfDuplication = 25;
var probabilityOfDuplication;
var randomUserTaskCount = 0;
var taskStartIndex;
var arrayDouble = [];

var getNumberOfDuplicateItems = function getNumberOfDuplicateItems(arr) {
  return arr.length - _toConsumableArray(new Set(arr)).length;
};

var renderTask = function renderTask(element, data) {
  var item = itemTemplate.cloneNode(true);
  var itemLabel = item.querySelector('.custom-toggle__label');
  var itemDescription = item.querySelector('.custom-toggle__description');
...
var fillElements = function fillElements(data) {
  var fragment = document.createDocumentFragment();
  findUserQuantity(data);
  var randomUser = getRandomInt(1, userQuantity);
...
var findUserQuantity = function findUserQuantity(data) {
...
var findUserTaskCount = function findUserTaskCount(data, user) {
  data.forEach(function (item) {
    if (item.userId === user) {
...
/* harmony import */ var _addTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addTask */ "./js/modules/addTask.js");

var END_POINT = 'https://jsonplaceholder.typicode.com/todos';
...
var successHandler = function successHandler(data) {
  Object(_addTask__WEBPACK_IMPORTED_MODULE_0__["addTask"])(data);
};
...
var createXhr = function createXhr(onSuccess, onError) {
  ...
  xhr.addEventListener('load', function () {
    if (xhr.status === statusCode.OK) {
      ...
      onError("\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u0442\u0432\u0435\u0442\u0430: ".concat(messageOfError[xhr.status]));
    }
  });
